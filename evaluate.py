...
from utils import mkstr, write_to_config_file, convert_frame,                  classification_acc, setup_env, setup_exp, setup_exp_dir,                  parse_minigrid_env_name, get_upper, get_exp_nickname
...
#.models/train/96MGE8/beta_vae/lr0.00025beta\=2/
